...
<head>
    ...
    <link href="../templates/1/web/css/styles.css" rel="stylesheet">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>Remplissez ce formulaire pour vous inscrire au coucours d'entrée</h2>
                        <p>Une fois les champs remplisl, vos données seront envoyées aux administrateurs qui traiteront vos dossiers et vous feront par de la présélection par mail</p>
                    ...
                    <div class="form-container">
                        <form id="registrationForm" data-toggle="validator" data-focus="false">
                            ...
                            <div class="form-group">
                                ...
                                <label class="label-control" for="remail">Prénom(s)</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="date" class="form-control-input" id="dnais" name="dnais" required>
                                <label class="label-control" for="dnais">Date de naissance</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="country" name="country" required>
                                    <option value="nat" selected>Nationalité</option>
                            ...
                            <div class="form-group checkbox">
                                ...
                                <input type="checkbox" id="sexe" value="M" name="sexe" required>M
                                <input type="checkbox" id="sexe" value="F" name="sexe">F
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">

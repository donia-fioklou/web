        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <p class="text-muted mb-4" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".4">IAI-TOGO
              En application de la décision du Conseil d’Administration de délocaliser l’IAI, la Représentation du TOGO (IAI-TOGO) a ouvert ses portes le 24 octobre 2002. 
              L’accord d’établissement entre la République Togolaise et l’Institut Africain d’Informatique a été signée le 12 mai 2006.
              </p>
    ...
    <div class="row align-items-center">
      <div class="col-md-6 order-2 order-md-1">
        ...
        <p>
          ...
          Mathématiques, durée 4 heures, coefficient 6,<br>
        ...
        <a href="formulaire.php" class="btn btn-primary-outline">S'inscrire au concours</a>
      </div>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <a href="course-single.html">
          <h4 class="card-title">sytème réseaux</h4>
        </a>
        <p class="card-text mb-4">La filière Systèmes et Réseaux, créée il y a deux ans forme des informaticiens capables de concevoir, implanter, interconnecter et administrer des réseaux informatiques et d’assurer également la maintenance de tout matériel informatique. L’accent est donc mis sur l’étude des réseaux sous la norme CISCO CCNA, les systèmes d’exploitation, l’électricité, l’électronique et la maintenance.</p>
        <p class="card-text mb-4">A cet effet, l’IAI-TOGO met à la disposition de ses étudiants des salles de réseaux équipées de micro-ordinateurs le tout dans un réseau local pour le partage des ressources.
        La formation est très pratique. La première promotion de sept (7) étudiants ont reçu leur diplôme en 2010.</p>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <a href="course-single.html">
          <h4 class="card-title">Multimédia</h4>
        </a>
        <p class="card-text mb-4"> La licence Multimédia, Technologie Web et Infographie (M-TWI), vise à apporter aux étudiants les compétences nécessaires pour réussir leur projet, qu’il soit de création, d’administration ou d’industrialisation des produits de communication audiovisuelle.
        L’identité de la formation est liée à la nature pluridisciplinaire des enseignements (connaissance technologiques, informatique, gestion de projet, création audiovisuelle, infographie) et à l’opportunité d’affirmer une bonne communication via des documents multimédias. Il s’agit aussi d’intégrer une culture de management de projets multimédia et infographie. </p>
